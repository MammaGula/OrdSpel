...
namespace OrdSpel.DAL.Data.SeededData
{
    public class SeededAppData
    {
        ...
        public static async Task SeedCountriesAsync(AppDbContext context)
        {
            ...
            {
                // A
"Afghanistan", "Albanien", "Algeriet", "Andorra", "Angola", "Antigua och Barbuda",
"Argentina", "Armenien", "Australien", "Azerbajdzjan",

// B
"Bahamas", "Bahrain", "Bangladesh", "Barbados", "Belarus", "Belgien", "Belize",
"Benin", "Bhutan", "Bolivia", "Bosnien och Hercegovina", "Botswana", "Brasilien",
"Brunei", "Bulgarien", "Burkina Faso", "Burundi",

// C
"Centralafrikanska republiken", "Chile", "Colombia", "Comorerna",

// D
"Danmark", "Djibouti", "Dominica", "Dominikanska republiken",

// E
"Ecuador", "Egypten", "El Salvador", "Ekvatorialguinea", "Eritrea", "Estland",
"Eswatini", "Etiopien",
...
"Kirgizistan", "Kiribati", "Komorerna", "Kongo-Brazzaville", "Kosovo", "Kroatien",
"Kuba", "Kuwait",

// L
"Laos", "Lettland", "Libanon", "Liberia", "Libyen", "Liechtenstein", "Litauen",
"Luxemburg",

// M
"Madagaskar", "Malawi", "Malaysia", "Maldiverna", "Mali", "Malta", "Marocko",
"Marshallöarna", "Mauretanien", "Mauritius", "Mexiko", "Mikronesien", "Moldavien",
"Monaco", "Mongoliet", "Montenegro", "Mozambique", "Myanmar",

// N
"Namibia", "Nauru", "Nepal", "Nicaragua", "Nederländerna", "Niger", "Nigeria",
"Nordkorea", "Nordmakedonien", "Norge", "Nya Zeeland",

// O
"Oman",

// P
"Pakistan", "Palau", "Panama", "Papua Nya Guinea", "Paraguay", "Peru", "Polen",
"Portugal",
...
// R
"Republiken Kongo", "Rumänien", "Rwanda", "Ryssland",

// S
"Saint Kitts och Nevis", "Saint Lucia", "Saint Vincent och Grenadinerna", "Samoa",
"San Marino", "Saudiarabien", "Senegal", "Serbien", "Seychellerna", "Sierra Leone",
"Singapore", "Slovakien", "Slovenien", "Somalia", "Spanien", "Sri Lanka", "Sudan",
"Surinam", "Sverige", "Schweiz", "Syrien", "Sydafrika", "Sydkorea", "Sydsudan",

// T
"Tadzjikistan", "Tanzania", "Thailand", "Timor-Leste", "Togo", "Tonga",
"Trinidad och Tobago", "Tunisien", "Turkiet", "Turkmenistan", "Tuvalu", "Taiwan", "Tyskland", "Tjeckien",
...
"Zambia", "Zimbabwe",
        ...
        public static async Task SeedAnimalsAsync(AppDbContext context)
        {
            ...
            var animals = new List<string>
            {
                ...
                "anka", "alligator", "axolotl", "ara", "andalusisk häst", "and",
                // B
                ...
                // S
                "säl", "sork", "sandödla", "skarv", "skata", "sköldpadda", "snok", "sengångare", "sjöhäst", "sjölejon",
